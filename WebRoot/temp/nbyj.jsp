    ...
    <script type="text/javascript">
        ...
        $(function ()
        {
            ...
            $("#maingrid").ligerGrid({
                height:'100%',
                columns: [
                { display: '发件人', name: 'CustomerID', align: 'left', width: 100, minWidth: 60 },
                ...
                toolbar: { items: [
                { text: '写消息', click: itemclick, icon: 'modify' },
                { line: true },
                { text: '未读', click: itemclick, icon: 'modify' },
                { line: true },
                { text: '收件箱', click: itemclick, icon: 'modify' },
                { line: true },
                { text: '发件箱', click: itemclick, icon: 'modify' },
                { line: true },
                ]
                }
            });
