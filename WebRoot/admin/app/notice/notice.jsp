...
<head>
    ...
    <script src='<%=basePath%>dwr/engine.js' type='text/javascript' ></script>
  	...
  	<script src='<%=basePath%>dwr/interface/NoticeAction.js' type='text/javascript' ></script>
    <style type="text/css">
  ...
  <script type="text/javascript">
	...
	grid.toolbarManager.set('items', items);
      ...
      function toolbarBtnItemClick(item)
      {
          ...
          switch (item.id) {
              ...
              case "view":
                  ...
                  dialog = $.ligerDialog.open({ url: '<%=basePath%>noticeView?notice.n_xh=' + selected.n_xh, 
                     	height: 500,width: 900,showMax: true, showToggle: true,  showMin: true
				});
                  break;
              case "modify":
      ...
      function f_delete() {
          ...
          if (selected) {
              ...
              **/
        	  ...
        	  NoticeAction.noticeDelete(selected.n_xh, function (result){
             	   if(result == 'success'){
             		  LG.showSuccess('删除成功');
	           	   } else {
	           		  LG.showError('删除失败');
      ...
      function loadGrid(){
	 	  ...
	 	  NoticeAction.noticeList(function (data){
