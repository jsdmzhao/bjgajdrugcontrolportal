...
<head>
    ...
    <script src='<%=basePath%>dwr/engine.js' type='text/javascript' ></script>
  	...
  	<script src='<%=basePath%>dwr/interface/CarKeepAction.js' type='text/javascript' ></script>
...
<body style="padding:10px;height:100%; text-align:center;">
  ...
  <script type="text/javascript">
      ...
      function f_delete() {
          var selected = grid.getSelected();
          if (selected) {
        	  CarKeepAction.carKeepDelete(selected.n_xh, function (result){
             	   if(result == 'success'){
             		  LG.showSuccess('删除成功');
      ...
      grid.bind('afterSubmitEdit', function (e) {
          ...
          CarKeepAction.carKeepSave(data, function (result){
        	if(result == 'success'){
        		LG.showSuccess('保存成功');
      		} else {
      			LG.showSuccess('保存失败');
