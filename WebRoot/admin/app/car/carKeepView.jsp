...
<body style="padding-bottom:31px;">
     ...
     var config = {"Form":{ 
       fields : [{
         ...
         ,
        {
         ...
         labelWidth:130,
         type:"text",
         value:"<s:property value='carKeep.d_sqrq'/>",
         validate: { required: true},
        ...
        ,
        {
         ...
         labelWidth:130,
         newline:false,
         value:"<s:property value='carKeep.n_clxszlc'/>",
         width:280,
         validate: { required: true},
         type:"number"
        }
        ,
        {
         display:"车辆状况", 
         name:"c_clzk",
         value:"<s:property value='carKeep.c_clzk'/>",
         newline:true,
         labelWidth:130,
         validate: { required: true},
         width:732,
        ...
        ,
        {
         ...
         name:"c_sxry",
         newline:true,
         value:"<s:property value='carKeep.c_sxry'/>",
         labelWidth:130,
         validate: { required: true},
         width:280,
         type:"text"
        ...
        ,
        {
         display:"联系方式", 
         name:"c_lxfs",
         value:"<s:property value='carKeep.c_lxfs'/>",
         labelWidth:130,
         newline:false,
         validate: { required: true},
         width:280,
        ...
        {
         name:"n_xh",
         value:"<s:property value='carKeep.n_xh'/>",
         type:"hidden"
        }
       ]
	 }};
    ...
    cmb1 = $("#c_bm").ligerComboBox({ data: tempdata, isMultiSelect: false,
         ...
         value:"<s:property value='carKeep.c_yhzid_'/>",
    ...
    cmb2 = $("#n_cllbxh").ligerComboBox({
         ...
         valueField:"value",
         textFiled:"text",
         value:"<s:property value='carKeep.n_cllbxh'/>",
