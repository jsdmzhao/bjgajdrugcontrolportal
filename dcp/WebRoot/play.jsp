...
<input type="image" width="21" height="17" class="searchaction" onclick="if(document.forms['search'].searchinput.value=='- Search Products -')document.forms['search'].searchinput.value='';" alt="Search" src="images/magglass.gif" border="0" hspace="2"/>
	...
	padding-top:5px;margin-left:20px;">最新资讯</div>
      <div style="height:300px; width:400px; margin-left:40px; margin-top:10px;float:left;">
        <video id="player_a" class="projekktor" poster="media/intro.png" title="this is Projekktor" width="350" height="300" controls>
          <source src="media/intro.ogv" type="video/ogg" />
          <source src="media/intro.mp4" type="video/mp4" />
          <source src="media/intro.webm" type="video/mp4" />
        </video>
