...
<%
  ...
  String defaultPic =path+"/client/platframe/fileupload/image/man.GIF";
  if("3".equals(step))
    defaultPic = path+"/upload/images/"+"fin_"+picUrl;
%>
...
<link href="css/main.css" type="text/css" rel="Stylesheet" />
    ...
    <script type="text/javascript">
       ...
       function doSubmint(){
            //$(parent.$("#formIframe")).$("#imageSrc").attr("src","<%=defaultPic%>");
           $(window.parent.formIframe.document).find("#imageSrc").attr("src","<%=defaultPic%>");
       		parent.$("#imageUploadDiv").dialog("close");
...
<body>
    ...
    <div>
     <div class="left">
         ...
         <div id="CurruntPicContainer">
            ...
            <div class="photocontainer">
                <img id="imgphoto" src="<%=defaultPic%>" style="border-width:0px;" />
                  ...
                  <center><input type="button" value="确定" onclick="doSubmint()"/> </center>
            </div>
         </div>
         <!--Step 2-->
           ...
           <div class="uploadtooltip">您可以拖动照片以裁剪满意的头像</div>                              
                   <div id="Canvas" class="uploaddiv">
                            ...
                            <div id="ImageDragContainer">                               
                               <img id="ImageDrag" class="imagePhoto" src="<%=path %>/upload/images/<%=picUrl %>" style="border-width:0px;" />                                                        
                            </div>
                            <div id="IconContainer">                               
                               <img id="ImageIcon" class="imagePhoto" src="<%=path %>/upload/images/<%=picUrl%>" style="border-width:0px;" />                                                        
                            </div>                          
                    </div>
                    <div class="uploaddiv">
                       <table>
                    ...
                    <form action="zoomImage.jsp" method="post">
      ...
      <form name="form1" method="post" action="uploadUserHeadImage.jsp" id="form1" enctype="multipart/form-data">
     <div class="right">
         <!--Step 1-->
