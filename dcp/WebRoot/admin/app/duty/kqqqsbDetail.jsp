...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script type='text/javascript' src='<%=basePath%>dwr/engine.js'></script>
  	...
  	<script type='text/javascript' src='<%=basePath%>dwr/interface/KqQqsbSvc.js'></script>
    ...
    var box1;
      ...
      //  $("#RoleID").val(roleids);
        ...
        //    mform.attr("action", actionRoot + "newsSave");
             ...
             var obj={nXh:'<%=nXh%>'};
        	KqQqsbSvc.queryAll(obj, function (rdata)
                    {
        		    if(rdata != null){
        		    	var data=rdata[0];
                        var preID =  "";
        ...
        function f_save() {
			...
			if(isAddNew){
        	KqQqsbSvc.save(formMap,function (rdata){
        		if (rdata) {
        	   	...
        	   	KqQqsbSvc.update(formMap,function (rdata){
        	   		if (rdata) {
