...
<body style="padding:10px;height:100%; text-align:center;">
  ...
  <script type="text/javascript">
      ...
      var grid = $("#maingrid").ligerGrid({
          ...
          { display: "网址类别", name: "c_lbmc", width: 280, type: "text", align: "left"
	...
	grid.toolbarManager.set('items', items);
      ...
      function toolbarBtnItemClick(item)
      {
          ...
          switch (item.id) {
              ...
              case "view":
                  ...
                  top.f_addTab(null, '查看网址类别信息', '<%=basePath%>admin/app/role/roleDetail.jsp?IsView=1&ID=' + selected.RoleID);
                  break;
              case "modify":
                  var selected = grid.getSelected();
                  if (!selected) { LG.tip('请选择行!'); return }
      ...
      function f_delete() {
          ...
          if (selected) {
        	  ...
        	  **/
        	  ...
        	  WebsiteAction.webtypeDelete(selected.n_xh, function (result){
             	   if(result == 'success'){
             		  LG.showSuccess('删除成功');
	           	   } else {
	           		  LG.showSuccess('删除失败');
      ...
      grid.bind('afterSubmitEdit', function (e)
      {
          ...
          WebsiteAction.webtypeSave(data, function (result){
        	if(result == 'success'){
        		LG.showSuccess('保存成功');
      		} else {
      			LG.showSuccess('保存失败');
      ...
      function loadGrid(){
    	...
    	WebsiteAction.webtypeList(function (data){
