...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <script type="text/javascript"> 
        var config = {"Form":{ 
         ...
         {display:"是否图片文章",name:"DeptID",newline:true,labelWidth:100,width:220,space:30,type:"select",comboboxName:"DepartmentDeptName",options:{tree:{
         ...
         {display:"是否视频文章",name:"Deptd",newline:true,labelWidth:100,width:220,space:30,type:"select",comboboxName:"DepartmentDeptNamde",options:{tree:{
            url :'../handler/tree.ashx?view=CF_Department&idfield=DeptID&textfield=DeptName&pidfield=DeptParentID',
            checkbox:false,
            nodeWidth :220
        },valueFieldID:"DeptID",valueField:"DeptID"}},
