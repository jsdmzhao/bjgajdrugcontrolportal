...
<script type="text/javascript"
	src="<%=basePath%>highslide/highslide-with-html.js"></script>
<link rel="stylesheet" type="text/css"
	href="<%=basePath%>highslide/highslide.css" />
<!-- 弹出窗 -->
...
footerhtml+='<input type="image" alt="Cancel" src="<%=basePath%>images/cancel_button.gif" class="btn" id="msg'
	...
	<div id="container2">
		...
		<div
			...
			<div
				style=" width:290px; height:504px; float:left;  margin-right:10px; margin-left:10px; margin-top:10px;
 ...
 background-repeat:no-repeat;">
			...
			<div id="new_list">
				<div
					style="background-image:url(<%=basePath%>images/navbg.png); width:670px; height:30px;"></div>
				<div
					style="width:670px; height:420px; padding-top:5px; margin-left:10px;"
					id="news">
					<ul>

						<s:if test="resMap.data.size()>=9">
							<s:iterator value="resMap.data" id="news" var="news" begin="0"
								end="9">
