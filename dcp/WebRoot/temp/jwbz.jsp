	...
	<body
		...
		<div id="mainbody" class="l-mainbody"
			...
			<div position="center" id="framecenter">
				<div tabid="home" title="警务保障">
					<iframe frameborder="0" name="home" id="home" src="<%=basePath%>admin/app/car/cartype.jsp"></iframe>
				</div>
			</div>
		</div>
		<script type="text/javascript">
        ...
        $(document).ready(function ()
        {
            ...
            var menus=[{
                    ...
                    "children":[{
                          ...
                          "MenuID":21,
                          "text":"油料报表",
                          "MenuUrl":"<%=basePath%>admin/app/car/carOilReport.jsp",
                          "MenuIcon":"<%=basePath%>liger/lib/icons/32X32/statistics.gif",
                          "MenuNo":"sysright",
                          "MenuParentNo":"system"
                         }],
                          "MenuName":"警务保障",
