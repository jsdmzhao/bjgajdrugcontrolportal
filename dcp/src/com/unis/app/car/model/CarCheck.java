...
public class CarCheck {
	...
	public void setD_jcrq(String d_jcrq) {
		this.d_jcrq = d_jcrq;
	}

	public String getC_jccmc() {
		return c_jccmc;
	}

	public void setC_jccmc(String c_jccmc) {
		this.c_jccmc = c_jccmc;
	}
	...
	public String getN_jcfy() {
		return n_jcfy;
	}

	public void setN_jcfy(String n_jcfy) {
		this.n_jcfy = n_jcfy;
	}
