...
@Repository
public class SysMenuDao<T> extends AbsServiceAdapter<T> {

	public Object saveInfo(Map p){
		return super.insert("SysMenuMapper.saveInfo", p);
	}

	public Object saveAllInfo(Map p){
		return super.insert("SysMenuMapper.saveAllInfo", p);
	}

	public Object removeInfo(Map p){
		return super.delete("SysMenuMapper.removeInfo", p);
	}

	public Object updateInfo(Map p){
		return super.update("SysMenuMapper.updateInfo", p);
	}

	public Object updateAllInfo(Map p){
		return super.update("SysMenuMapper.updateAllInfo", p);
	}

	public List queryAllInfo(Map p){
		return super.selectList("SysMenuMapper.queryAllInfo", p);
	}

	public List queryInfo(Map p){
		return super.selectList("SysMenuMapper.queryInfo", p);
	}

	public Object queryCountInfo(Map p) {
		return super.selectOne("SysMenuMapper.queryCountInfo", p);
	}
