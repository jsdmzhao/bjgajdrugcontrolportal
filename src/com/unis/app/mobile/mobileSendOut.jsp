...
<body style="padding-bottom:31px;">
    ...
    <script type="text/javascript"> 
        ...
        var config = {"Form":{ 
         fields : [
         {display:"接收人",name:"c_jsr",newline:true,labelWidth:100,width:700,space:30,type:"text",validate: { required: true},
       	  group:"基本信息",
        ...
        function f_save() {
        	...
        	MobileAction.mobileOutSave(formMap,function (result){
